...
import LandingHeader from '../../src/components/common/LandingHeader/LandingHeader';
import LandingFooter from '../../src/components/common/LandingFooter/LandingFooter';
...
// alt text and ratio are used for accessibility and correct sizing.
  ...
  const whoWeServeDropdownItems = [
     { name: 'Anesthesia & Perioperative Providers', href: '/' },
    { name: 'Surgical & Procedural Physicians', href: '/' },
    { name: 'Interventional & Diagnostic Physicians', href: '/' },
    { name: 'Ambulatory Surgical Centers', href: '/' }
  ];
